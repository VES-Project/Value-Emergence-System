...
On the other hand, to clarify the substance of our belief system, we must look beyond the realm of perception to the dimension of "action." We do not merely passively perceive the external world and reduce surprise each time. Using predictive mental images that imagine the future, we actively generate our own actions. And the action process, too, can be understood through the principle of surprise minimization.
